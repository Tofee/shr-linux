...
static int poll_status_reg(struct device *dev, u8 expected, const char *step)
{
	...
	expiry = ktime_get_ns() + pdat->status_reg_timeout_ms * NSEC_PER_MSEC;
...
static void cy8ctma395_device_remove(struct platform_device *pdev)
{
...
static const struct of_device_id cy8ctma395_match[] = {
	{ .compatible = "cypress,cy8ctma395", },
	{},
};
MODULE_DEVICE_TABLE(of, cy8ctma395_match);

static struct platform_driver cy8ctma395_driver = {
	.driver = {
		.name = CY8CTMA395_DRIVER,
		.of_match_table = cy8ctma395_match,
	},
	.probe = cy8ctma395_device_probe,
	.remove_new = cy8ctma395_device_remove,
};
